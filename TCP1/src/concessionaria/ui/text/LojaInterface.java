...
import concessionaria.ui.text.command.TransferenciaCommand;
...
public class LojaInterface extends ConcessionariaTextInterface{
	...
	public LojaInterface(Loja loja, Operacoes impl, OperacoesGerenciamento gerenciamento) {
		...
		this.adicionaAcao("8", new TransferenciaCommand(this, impl));
		this.adicionaAcao("9", new FuncionarioDoMesCommand(this, impl));
	}
}
